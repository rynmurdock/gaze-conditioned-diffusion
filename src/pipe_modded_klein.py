...
#
# ---------------------------------------------------------------------------
# NOTE: This is a standalone version of diffusers' `pipeline_flux2_klein.py`.
# It has been modified to use absolute imports (`diffusers.xxx`) instead of
# the original package-relative imports (`...xxx`, `..xxx`, `.xxx`), so that
# this single file can be placed anywhere on disk (e.g. outside the diffusers
