...
class ImageCFGFlux2KleinPipeline(DiffusionPipeline, Flux2LoraLoaderMixin):
    r"""
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if image_latents is not None:
                    ...
                    neg_latent_model_input = torch.cat([latents, torch.zeros_like(image_latents)], dim=1).to(self.transformer.dtype)
